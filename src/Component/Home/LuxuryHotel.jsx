    ...
    return (
        <>
            <div className='py-40 bg-[#f7f6f6]'>
                <div className='  w-[1200px] mx-auto flex justify-center items-center gap-6'>
                    <div className='leftPart'>
                        <div className=" flex justify-center items-center  ">
                            <div className=' w-[400px] mx-auto'>
                                ...
                                <h2 className=' font-medium text-6xl  font-serif' >Luxury Hotel</h2>
                    ...
                    <div className="rightPart w-[700px]">
